...
*/
Vue.component("fixed_left_side_hero_component_1721649544", {
    template: `
            ...
            <div class="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20 flex-1" id="quote-header">
                <div class="grow flex flex-col justify-center" id="quote-content">
                    <div class="space-y-3" id="quote-container">
                        <div id="quote-title" class="font-caveat text-3xl text-blue-500">Gain Unparalleled Insights with</div>
                        <h1 id="company-name" class="h1 font-orbiter font-bold text-white">Blockchain Analytics Unleashed</h1>
                        <time id="quote-date" class="block font-caveat text-xl text-slate-400">Our cutting-edge platform empowers you to analyze and interpret the latest blockchain data, unlocking invaluable business intelligence.</time>
                    </div>
                </div>
            </div>
        </div>
