...
*/
Vue.component("simple_footer_component_1721649453", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BlockTrend - Blockchain Analytics Platform
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with BlockTrend's advanced blockchain data analysis tools. Our platform provides real-time insights into emerging trends, helping you make informed decisions in the dynamic world of blockchain technology.
                    </div>
                </div>
            </div>
        </footer> 
